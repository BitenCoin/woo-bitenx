 ...
 * 
 * Donate BTENXuzAzNs1E1RBFhteX56A5353vyHuSJ5AYYQfoN97PNbcMDvwQo4pUWHs7SYpuD9ThvA7AD3r742kwTmWh5o9WFaB9JXH8evP
 * 
 * Reality is the concensus constructed between your neurons.
 */
class BitenX_Library {
    ...
    protected function getResponse($pRequest) {
        ...
        if (0 < curl_errno($ch)) {
           echo '[ERROR] Failed to connect to bitenx-wallet-rpc at ' . $this->host . ' port '. $this->port .'</br>';
        }
